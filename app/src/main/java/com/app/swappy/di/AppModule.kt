...
import com.app.swappy.core.ApiAdapter
import com.app.swappy.feature_account.data.remote.AccountApi
...
import com.app.swappy.feature_account.domain.use_case.DeleteAuthKeyUseCase
import com.app.swappy.feature_account.domain.use_case.GetAuthKeyUseCase
import com.app.swappy.feature_account.domain.use_case.GetCurrentUserProfileByTokenUseCase
import com.app.swappy.feature_account.domain.use_case.GetUserProfileById
import com.app.swappy.feature_account.domain.use_case.SaveAuthKeyUseCase
import com.app.swappy.feature_account.domain.use_case.SignInUseCase
import com.app.swappy.feature_account.domain.use_case.SignUpUseCase
import com.app.swappy.feature_account.domain.use_case.UploadAvatar
...
import com.app.swappy.feature_advertisement.domain.use_case.*
...
import com.app.swappy.feature_chat.domain.use_case.ChatUseCases
import com.app.swappy.feature_chat.domain.use_case.GetMessagesByRoom
import com.app.swappy.feature_chat.domain.use_case.GetMyRooms
import com.app.swappy.feature_chat.domain.use_case.GetOrCreatePrivateRoom
import com.app.swappy.feature_chat.domain.use_case.SendMessage
